...
enum ClipboardToolbarWidgets {
	...
	WID_CT_COPY,                                            ///< Copy button
	WID_CT_PASTE,                                           ///< Paste button

	WID_CT_PASTE_FLAG_BUTTON_BEGIN,                         ///< First button to toggle copy-paste flag
	WID_CT_WITH_RAIL = WID_CT_PASTE_FLAG_BUTTON_BEGIN,      ///< Toggle rails button (newgame only)
	WID_CT_WITH_ROAD,                                       ///< Toggle roads button
	WID_CT_WITH_WATER,                                      ///< Toggle water button
	WID_CT_WITH_AIR,                                        ///< Toggle air button (newgame only)
	WID_CT_MIRROR_SIGNALS,                                  ///< Toggle signal mirrorig button (newgame only)
	WID_CT_UPGRADE_BRIDGES,                                 ///< Toggle bridge upgrading button (newgame only)
	WID_CT_WITH_STATIONS,                                   ///< Toggle stations button (newgame only)
	WID_CT_WITH_OBJECTS,                                    ///< Toggle objects button (scenario editor only)
	WID_CT_WITH_HOUSES,                                     ///< Toggle houses button (scenario editor only)
	WID_CT_WITH_INDUSTRIES,                                 ///< Toggle industries button (scenario editor only)
	WID_CT_WITH_RIVERS,                                     ///< Toggle rivers button (scenario editor only)
	WID_CT_WITH_TREES,                                      ///< Toggle trees button (scenario editor only)
	WID_CT_WITH_GROUND,                                     ///< Toggle ground button (scenario editor only)
	WID_CT_PASTE_FLAG_BUTTON_END,                           ///< Past-the-last button to toggle copy-paste flag

	WID_CT_CONVERT_RAILTYPE = WID_CT_PASTE_FLAG_BUTTON_END, ///< Button to select railtype to convert to (newgame only)
