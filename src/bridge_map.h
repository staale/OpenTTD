 ...
 */
template <typename Tindex>
static inline void MakeBridgeRamp(const Tindex &t, Owner o, BridgeType bridgetype, DiagDirection d, TransportType tt)
{
 ...
 */
template <typename Tindex>
static inline void MakeRoadBridgeRamp(const Tindex &t, Owner o, Owner owner_road, Owner owner_tram, BridgeType bridgetype, DiagDirection d, RoadType road_rt, RoadType tram_rt)
{
 ...
 */
template <typename Tindex>
static inline void MakeRailBridgeRamp(const Tindex &t, Owner o, BridgeType bridgetype, DiagDirection d, RailType rt)
{
